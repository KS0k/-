...
screen.fill(GREY)
rect = (screen, GREY, (0, 0, 50, 50))
arc(screen, BLACK, (0, 0, 50, 50), pi, -pi * 0.5, 1)
screen2 = pygame.transform.rotate(screen, 270)
sc.blit(screen2, (362, 710))
...
#нитка
arc(sc, GREY, (280, 750, 100, 20), 0, pi * 0.96, 1)
arc(sc, GREY, (219, 747, 60, 20), 0, pi * 0.96, 1)
arc(sc, GREY, (170, 748, 50, 10), 0, pi * 0.96, 1)
